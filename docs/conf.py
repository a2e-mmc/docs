...
latex_documents = [
    (master_doc, 'MMC.tex', u'MMC Documentation',
     u'Eliot Quon', 'manual'),
]
...
man_pages = [
    (master_doc, 'mmc', u'MMC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MMC', u'MMC Documentation',
     author, 'MMC', 'One line description of project.',
     'Miscellaneous'),
]
